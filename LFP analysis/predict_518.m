...
save(['lfp_predict_', fname,'_518'],'P1','Bin','Neurons','-v7.3')
...
bins=2:5; % new period is too colse to the default one.
bincen=Bin.cen;
...
%                         Mebr=Br*Ar';
        ...
        save(['lfp_predict_', fname, '_' hemi{ihemi} '_' whatwhere{iww},'_518'],'Maa','Maar','Bin','tarray','ncho','nf')
    end
end